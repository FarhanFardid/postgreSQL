...
(1, 101, 'John Doe', 20, 'CSE', 85, 'passed', '2024-05-01', 'john.doe@example.com'),
(2, 102, 'Alice Smith', 21, 'EEE', 78, 'passed', '2024-05-03', 'alice.smith@example.com'),
(3, 103, 'Bob Johnson', 22, 'CSE', 59, 'passed', '2024-05-05', 'bob.johnson@example.com'),
(4, 104, 'Emma Brown', 19, 'BBA', 92, 'passed', '2024-05-07', 'emma.brown@example.com'),
(5, 105, 'Liam Davis', 23, 'CSE', 40, 'failed', '2024-05-10', 'liam.davis@example.com'),
(6, 106, 'Olivia Wilson', 20, 'EEE', 66, 'passed', '2024-05-11', 'olivia.wilson@example.com'),
(7, 107, 'Noah Garcia', 24, 'BBA', 88, 'passed', '2024-05-12', 'noah.garcia@example.com'),
(8, 108, 'Ava Martinez', 22, 'CSE', 73, 'passed', '2024-05-13', 'ava.martinez@example.com'),
(9, 109, 'William Lee', 21, 'EEE', 51, 'passed', '2024-05-14', 'william.lee@example.com'),
(10, 110, 'Sophia Clark', 20, 'BBA', 36, 'failed', '2024-05-15', 'sophia.clark@example.com'),
(11, 111, 'James Lewis', 23, 'CSE', 95, 'passed', '2024-05-16', 'james.lewis@example.com'),
(12, 112, 'Isabella Walker', 19, 'EEE', 44, 'failed', '2024-05-17', 'isabella.walker@example.com'),
(13, 113, 'Benjamin Hall', 20, 'BBA', 67, 'passed', '2024-05-18', 'benjamin.hall@example.com'),
(14, 114, 'Mia Allen', 22, 'CSE', 89, 'passed', '2024-05-19', 'mia.allen@example.com'),
...
(17, 117, 'Henry King', 24, 'CSE', 77, 'passed', '2024-05-22', 'henry.king@example.com'),
(18, 118, 'Amelia Wright', 23, 'EEE', 91, 'passed', '2024-05-23', 'amelia.wright@example.com'),
(19, 119, 'Logan Scott', 22, 'BBA', 62, 'passed', '2024-05-24', 'logan.scott@example.com'),
(20, 120, 'Harper Green', 21, 'CSE', 83, 'passed', '2024-05-20', 'harper.green@example.com');
