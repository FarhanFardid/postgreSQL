...
-- op1: Retrieve all employees whose salary is greater than the highest salary of the HR dept.
...
-- op2: find information of all employee whose department name has 'R' letter in them;

select * from employees2 where department_name in (select department_name from employees2 where department_name like '%R%');